...
use Packagerator\Model\Role;
use Packagerator\Model\RoleQuery;
...
class RoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Packagerator.Model.Map.RoleTableMap';
     ...
     */
    const OM_CLASS = '\\Packagerator\\Model\\Role';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Packagerator.Model.Role';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Packagerator\\Model\\Role');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Packagerator\Model\Role) { // it's a model object
