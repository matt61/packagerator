...
use Packagerator\Model\Target;
use Packagerator\Model\TargetQuery;
...
class TargetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Packagerator.Model.Map.TargetTableMap';
     ...
     */
    const OM_CLASS = '\\Packagerator\\Model\\Target';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Packagerator.Model.Target';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Packagerator\\Model\\Target');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Packagerator\Model\Target) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(TargetTableMap::DATABASE_NAME);
            $criteria->add(TargetTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TargetTableMap::COL_ID) && $criteria->keyContainsValue(TargetTableMap::COL_ID) ) {
