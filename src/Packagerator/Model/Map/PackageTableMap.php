...
class PackageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Packagerator.Model.Map.PackageTableMap';
     ...
     */
    const OM_CLASS = '\\Packagerator\\Model\\Package';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Packagerator.Model.Package';
     ...
     */
    const COL_NAME = 'package.name';

    /**
     * the column name for the version field
     */
    const COL_VERSION = 'package.version';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Version', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'version', ),
        self::TYPE_COLNAME       => array(PackageTableMap::COL_ID, PackageTableMap::COL_NAME, PackageTableMap::COL_VERSION, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'version', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Version' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'version' => 2, ),
        self::TYPE_COLNAME       => array(PackageTableMap::COL_ID => 0, PackageTableMap::COL_NAME => 1, PackageTableMap::COL_VERSION => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'version' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Packagerator\\Model\\Package');
    ...
    {
        $this->addRelation('PackageDependancyRelatedByPackageId', '\\Packagerator\\Model\\PackageDependancy', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':package_id',
    1 => ':id',
  ),
), null, null, 'PackageDependanciesRelatedByPackageId', false);
        $this->addRelation('PackageDependancyRelatedByRequiredPackageId', '\\Packagerator\\Model\\PackageDependancy', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PackageTableMap::COL_VERSION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Packagerator\Model\Package) { // it's a model object
