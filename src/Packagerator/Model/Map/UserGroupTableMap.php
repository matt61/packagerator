...
use Packagerator\Model\UserGroup;
use Packagerator\Model\UserGroupQuery;
...
class UserGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Packagerator.Model.Map.UserGroupTableMap';
     ...
     */
    const OM_CLASS = '\\Packagerator\\Model\\UserGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Packagerator.Model.UserGroup';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Packagerator\\Model\\UserGroup');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Packagerator\Model\UserGroup) { // it's a model object
