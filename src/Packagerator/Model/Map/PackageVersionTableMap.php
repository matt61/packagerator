...
class PackageVersionTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Version', 'PackageDependancyIds', 'PackageDependancyVersions', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'version', 'packageDependancyIds', 'packageDependancyVersions', ),
        self::TYPE_COLNAME       => array(PackageVersionTableMap::COL_ID, PackageVersionTableMap::COL_NAME, PackageVersionTableMap::COL_VERSION, PackageVersionTableMap::COL_PACKAGE_DEPENDANCY_IDS, PackageVersionTableMap::COL_PACKAGE_DEPENDANCY_VERSIONS, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'version', 'package_dependancy_ids', 'package_dependancy_versions', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Version' => 2, 'PackageDependancyIds' => 3, 'PackageDependancyVersions' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'version' => 2, 'packageDependancyIds' => 3, 'packageDependancyVersions' => 4, ),
        self::TYPE_COLNAME       => array(PackageVersionTableMap::COL_ID => 0, PackageVersionTableMap::COL_NAME => 1, PackageVersionTableMap::COL_VERSION => 2, PackageVersionTableMap::COL_PACKAGE_DEPENDANCY_IDS => 3, PackageVersionTableMap::COL_PACKAGE_DEPENDANCY_VERSIONS => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'version' => 2, 'package_dependancy_ids' => 3, 'package_dependancy_versions' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
