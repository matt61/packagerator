...
use Packagerator\Model\TargetGroup;
use Packagerator\Model\TargetGroupQuery;
...
class TargetGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Packagerator.Model.Map.TargetGroupTableMap';
     ...
     */
    const OM_CLASS = '\\Packagerator\\Model\\TargetGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Packagerator.Model.TargetGroup';
     ...
     */
    const COL_ID = 'target_group.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'target_group.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TargetGroupTableMap::COL_ID, TargetGroupTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TargetGroupTableMap::COL_ID => 0, TargetGroupTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Packagerator\\Model\\TargetGroup');
    ...
    {
        $this->addRelation('Target', '\\Packagerator\\Model\\Target', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':target_group_id',
    1 => ':id',
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TargetGroupTableMap::COL_ID);
            $criteria->addSelectColumn(TargetGroupTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Packagerator\Model\TargetGroup) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(TargetGroupTableMap::DATABASE_NAME);
            $criteria->add(TargetGroupTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TargetGroupTableMap::COL_ID) && $criteria->keyContainsValue(TargetGroupTableMap::COL_ID) ) {
