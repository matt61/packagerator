...
use \Exception;
use \PDO;
use Packagerator\Model\PropertyType as ChildPropertyType;
use Packagerator\Model\PropertyTypeQuery as ChildPropertyTypeQuery;
use Packagerator\Model\Map\PropertyTypeTableMap;
...
/**
 * Base class that represents a query for the 'property_type' table.
 *
 *
 *
 * @method     ChildPropertyTypeQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildPropertyTypeQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildPropertyTypeQuery orderByPropertyTypeId($order = Criteria::ASC) Order by the property_type_id column
 *
 * @method     ChildPropertyTypeQuery groupById() Group by the id column
 * @method     ChildPropertyTypeQuery groupByName() Group by the name column
 * @method     ChildPropertyTypeQuery groupByPropertyTypeId() Group by the property_type_id column
 *
 ...
 *
 * @method     ChildPropertyType findOneById(int $id) Return the first ChildPropertyType filtered by the id column
 * @method     ChildPropertyType findOneByName(string $name) Return the first ChildPropertyType filtered by the name column
 * @method     ChildPropertyType findOneByPropertyTypeId(int $property_type_id) Return the first ChildPropertyType filtered by the property_type_id column *
 ...
 *
 * @method     ChildPropertyType requireOneById(int $id) Return the first ChildPropertyType filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPropertyType requireOneByName(string $name) Return the first ChildPropertyType filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPropertyType requireOneByPropertyTypeId(int $property_type_id) Return the first ChildPropertyType filtered by the property_type_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPropertyType[]|ObjectCollection findById(int $id) Return ChildPropertyType objects filtered by the id column
 * @method     ChildPropertyType[]|ObjectCollection findByName(string $name) Return ChildPropertyType objects filtered by the name column
 * @method     ChildPropertyType[]|ObjectCollection findByPropertyTypeId(int $property_type_id) Return ChildPropertyType objects filtered by the property_type_id column
...
abstract class PropertyTypeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Packagerator\Model\Base\PropertyTypeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Packagerator\\Model\\PropertyType', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, property_type_id FROM property_type WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PropertyTypeTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PropertyTypeTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PropertyTypeTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PropertyTypeTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropertyTypeTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PropertyTypeTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByPropertyTypeId($propertyTypeId = null, $comparison = null)
    {
        if (is_array($propertyTypeId)) {
            ...
            if (isset($propertyTypeId['min'])) {
                $this->addUsingAlias(PropertyTypeTableMap::COL_PROPERTY_TYPE_ID, $propertyTypeId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($propertyTypeId['max'])) {
                $this->addUsingAlias(PropertyTypeTableMap::COL_PROPERTY_TYPE_ID, $propertyTypeId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropertyTypeTableMap::COL_PROPERTY_TYPE_ID, $propertyTypeId, $comparison);
    }
    ...
    {
        if ($propertyType) {
            $this->addUsingAlias(PropertyTypeTableMap::COL_ID, $propertyType->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the property_type table.
     *
