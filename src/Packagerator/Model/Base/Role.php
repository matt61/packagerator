...
use \Exception;
use \PDO;
use Packagerator\Model\RoleQuery as ChildRoleQuery;
use Packagerator\Model\Map\RoleTableMap;
...
abstract class Role implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Packagerator\\Model\\Map\\RoleTableMap';
    ...
    /**
     * Initializes internal state of Packagerator\Model\Base\Role object.
     */
     ...
     * @return $this|\Packagerator\Model\Role The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 1; // 1 = RoleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Packagerator\\Model\\Role'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Packagerator\Model\Role
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Packagerator\Model\Role The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Packagerator\Model\Role (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Packagerator\Model\Role Clone of current object.
     * @throws PropelException
     */
