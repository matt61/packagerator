...
use \Exception;
use \PDO;
use Packagerator\Model\UserGroupQuery as ChildUserGroupQuery;
use Packagerator\Model\Map\UserGroupTableMap;
...
abstract class UserGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Packagerator\\Model\\Map\\UserGroupTableMap';
    ...
    /**
     * Initializes internal state of Packagerator\Model\Base\UserGroup object.
     */
     ...
     * @return $this|\Packagerator\Model\UserGroup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Packagerator\\Model\\UserGroup'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Packagerator\Model\UserGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Packagerator\Model\UserGroup The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Packagerator\Model\UserGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Packagerator\Model\UserGroup Clone of current object.
     * @throws PropelException
     */
