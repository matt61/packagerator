...
use \Exception;
use \PDO;
use Packagerator\Model\Property as ChildProperty;
use Packagerator\Model\PropertyQuery as ChildPropertyQuery;
use Packagerator\Model\Map\PropertyTableMap;
 ...
 * @method     ChildPropertyQuery orderByPropertyTypeId($order = Criteria::ASC) Order by the property_type_id column
 * @method     ChildPropertyQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildPropertyQuery orderByVersionId($order = Criteria::ASC) Order by the version_id column
 * @method     ChildPropertyQuery orderByPropertyGroupId($order = Criteria::ASC) Order by the property_group_id column
 *
 * @method     ChildPropertyQuery groupById() Group by the id column
 * @method     ChildPropertyQuery groupByPropertyTypeId() Group by the property_type_id column
 * @method     ChildPropertyQuery groupByValue() Group by the value column
 * @method     ChildPropertyQuery groupByVersionId() Group by the version_id column
 * @method     ChildPropertyQuery groupByPropertyGroupId() Group by the property_group_id column
 *
 ...
 * @method     ChildProperty findOneByPropertyTypeId(int $property_type_id) Return the first ChildProperty filtered by the property_type_id column
 * @method     ChildProperty findOneByValue(string $value) Return the first ChildProperty filtered by the value column
 * @method     ChildProperty findOneByVersionId(int $version_id) Return the first ChildProperty filtered by the version_id column
 * @method     ChildProperty findOneByPropertyGroupId(int $property_group_id) Return the first ChildProperty filtered by the property_group_id column *
 ...
 * @method     ChildProperty requireOneByPropertyTypeId(int $property_type_id) Return the first ChildProperty filtered by the property_type_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProperty requireOneByValue(string $value) Return the first ChildProperty filtered by the value column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProperty requireOneByVersionId(int $version_id) Return the first ChildProperty filtered by the version_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProperty requireOneByPropertyGroupId(int $property_group_id) Return the first ChildProperty filtered by the property_group_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildProperty[]|ObjectCollection findByPropertyTypeId(int $property_type_id) Return ChildProperty objects filtered by the property_type_id column
 * @method     ChildProperty[]|ObjectCollection findByValue(string $value) Return ChildProperty objects filtered by the value column
 * @method     ChildProperty[]|ObjectCollection findByVersionId(int $version_id) Return ChildProperty objects filtered by the version_id column
 * @method     ChildProperty[]|ObjectCollection findByPropertyGroupId(int $property_group_id) Return ChildProperty objects filtered by the property_group_id column
...
abstract class PropertyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Packagerator\Model\Base\PropertyQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Packagerator\\Model\\Property', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, property_type_id, value, version_id, property_group_id FROM property WHERE id = :p0';
        try {
    ...
    public function filterByPropertyTypeId($propertyTypeId = null, $comparison = null)
    {
        if (is_array($propertyTypeId)) {
            ...
            if (isset($propertyTypeId['min'])) {
                $this->addUsingAlias(PropertyTableMap::COL_PROPERTY_TYPE_ID, $propertyTypeId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($propertyTypeId['max'])) {
                $this->addUsingAlias(PropertyTableMap::COL_PROPERTY_TYPE_ID, $propertyTypeId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropertyTableMap::COL_PROPERTY_TYPE_ID, $propertyTypeId, $comparison);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PropertyTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    public function filterByVersionId($versionId = null, $comparison = null)
    {
        if (is_array($versionId)) {
            ...
            if (isset($versionId['min'])) {
                $this->addUsingAlias(PropertyTableMap::COL_VERSION_ID, $versionId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($versionId['max'])) {
                $this->addUsingAlias(PropertyTableMap::COL_VERSION_ID, $versionId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropertyTableMap::COL_VERSION_ID, $versionId, $comparison);
    }
    ...
    public function filterByPropertyGroupId($propertyGroupId = null, $comparison = null)
    {
        if (is_array($propertyGroupId)) {
            ...
            if (isset($propertyGroupId['min'])) {
                $this->addUsingAlias(PropertyTableMap::COL_PROPERTY_GROUP_ID, $propertyGroupId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($propertyGroupId['max'])) {
                $this->addUsingAlias(PropertyTableMap::COL_PROPERTY_GROUP_ID, $propertyGroupId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropertyTableMap::COL_PROPERTY_GROUP_ID, $propertyGroupId, $comparison);
    }
