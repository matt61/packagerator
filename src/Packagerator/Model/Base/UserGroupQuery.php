...
use \Exception;
use \PDO;
use Packagerator\Model\UserGroup as ChildUserGroup;
...
abstract class UserGroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Packagerator\Model\Base\UserGroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Packagerator\\Model\\UserGroup', $modelAlias = null)
    {
