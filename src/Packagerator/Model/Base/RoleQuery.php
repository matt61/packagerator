...
use \Exception;
use \PDO;
use Packagerator\Model\Role as ChildRole;
...
abstract class RoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Packagerator\Model\Base\RoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Packagerator\\Model\\Role', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id FROM role WHERE id = :p0';
        try {
